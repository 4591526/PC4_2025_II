...
if pagina_seleccionada == 'Inicio':
    ...
    st.markdown("<h1 style='text-align: center;'>Aquí ustedes deben editar</h1>", unsafe_allow_html=True)
    ...
    ¿Qué te gustaría hacer con la programación en el futuro? Viernes
    """
    ...
    st.markdown("<h2 style='text-align: center;'> Videos realizados </h2>", unsafe_allow_html=True)
